...
export default function ReviewChatView() {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                const response = await fetch(`/api/dashboard/chat?vid=${converseId}`, { method: "GET" })
        ...
        <div className="min-h-screen bg-[#F5F6F8]">
            ...
            <div className="border-b border-gray-200 bg-white shadow-sm">
                <div className="container mx-auto px-4 py-3">
                    <Link href={`/dashboard/review/${converseId}`}>
            ...
            <div className="container mx-auto px-4 py-4 max-w-3xl space-y-4">
                ...
                <Card className="bg-amber-50 border-amber-200 p-4">
                    <p className="text-amber-700 text-sm font-medium">View-only mode — This is a record of your conversation.</p>
                </Card>
